  ...
  <q-card class="my-card q-ma-md">
    <q-card-section class="q-pb-none">
      <div class="row items-center justify-between">
        <div class="text-h6">Edit User Group</div>
                  ...
                  <q-card class="q-pa-md">
                    <q-card-section>
                      <div class="row q-col-gutter-md items-center">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                          <q-select dense outlined v-model="model" :options="PermissionLevel" label="Select Permission Level" />
                        </div>
                      </div>
                      <div class="row q-my-md q-col-gutter-md items-center">
                        <div class="col-12">
                          <q-input dense outlined v-model="text" label="Description" />
                        </div>
                      </div>
                  ...
                  <q-card class="q-pa-md">
                    <q-card-section>
                      <div class="row q-mb-md bg-grey-2 q-pa-sm">
                        ...
                        <div class="col-2 text-center text-weight-bold">List</div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        PermissionLevel: [
          'Full Access', 'Read Only', 'Limited Access', 'Custom'
        ],
        permissionNodes: [
          {
            id: 'crm',
            label: 'CRM',
            icon: 'group',
            permissions: { add: true, edit: true, delete: false, list: true, export: true, print: true },
            children: [
              {
                id: 'leads',
                label: 'Leads',
                icon: 'layers',
                permissions: { add: true, edit: true, delete: false, list: true, export: true, print: false }
              },
              {
                id: 'opportunities',
                label: 'Opportunities',
                icon: 'online_prediction',
                permissions: { add: true, edit: true, delete: false, list: true, export: false, print: false }
              }
            ]
          },
          {
            ...
            label: 'Finance',
            icon: 'receipt_long',
            permissions: { add: false, edit: false, delete: false, list: true, export: false, print: false },
            children: [
              {
                id: 'invoices',
                label: 'Invoice Management',
                icon: 'receipt',
                permissions: { add: false, edit: false, delete: false, list: true, export: false, print: true }
              },
              {
                id: 'payments',
          ...
          },
          {
            ...
            label: 'Reports',
            icon: 'bar_chart',
            permissions: { add: false, edit: false, delete: false, list: true, export: true, print: true }
          },
          {
            id: 'security',
            label: 'Security',
        ...
        text: 'Admin Group',
        model: 'Active',
        remarks: 'Default admin group with standard permissions'
      };
    }
  }
</script>
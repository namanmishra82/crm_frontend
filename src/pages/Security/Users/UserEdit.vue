  ...
  <q-card class="my-card q-ma-sm col-auto">
    <q-card-section class="q-pb-none">
      ...
      <div class="row items-center justify-between">
        ...
        <q-btn color="primary text-capitalize" label="Update User" icon="save" @click="updateUser" />
      </div>
      <!-- Subtitle -->
      <div class="text-subtitle2">Edit User Details</div>
    </q-card-section>
  ...
  setup() {
    ...
    const updateUser = async () => {
      try {
        loading.value = true
        const userId = route.params.id
        await apiService.updateUser(userId, form.value)

<template>
  ...
  <q-card class="my-card q-ma-md" style="max-height: contain; overflow-y: auto;">
    <q-card-section class="q-pb-none">
      <div class="row items-center justify-between">
        <div class="text-h6">Add Lead</div>
    ...
    <q-card-section class="q-px-none">
      <q-page class="q-px-none" style="height:auto;">
                    ...
                    <q-card-section>
                        ...
                        <div class="row q-col-gutter-md items-center">
                          ...
                          <div class="col-12 col-sm-6 col-md-4 col-lg-2">
                            <q-input dense outlined v-model="text" label="Status" />
                          </div>
                          <div class="col-12 col-sm-6 col-md-4 col-lg-2">
                            <q-input dense outlined v-model="text" label="Assigned To" />
                          </div>
                          <div class="col-12 col-sm-6 col-md-4 col-lg-2">
                            <!--   Date Picker -->
                        ...
                        <div class="row q-my-md q-col-gutter-md items-center">
                          ...
                          <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                            <q-input dense outlined v-model="text" label="Lead Source Campaign " />
                          </div>
                          <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                            <q-input dense outlined v-model="text" label="Event Name" />
                          </div>
                          <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                            <q-input dense outlined v-model="text" label="Priority" />
                          </div>
                        </div>

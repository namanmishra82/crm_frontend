  ...
  <q-card class="my-card q-ma-sm col-auto">
    <q-card-section class="q-pb-none">
      ...
      <div class="row items-center justify-between">
        <div class="text-h6">Trial Request</div>
        <q-btn color="primary text-capitalize" label="Add Request" icon="playlist_add" @click="Trial_RequestAdd" />
      </div>
      <!-- Subtitle -->
      ...
      <div class="q-pa-md" style="height:auto;">
        ...
        <div class="row q-col-gutter-md items-center">
          ...
          <div class="col-12 col-sm-6 col-md-4 col-lg-2">
            <q-input dense outlined v-model="date" mask="date" :rules="['date']" label="Select Request Date" :hide-bottom-space="true">
...
<script>
  ...
  export default {
    ...
    setup() {
      ...
      const Trial_RequestAdd = () => {
        router.push('/Trial_RequestAdd') // This route must be defined in your router
      }
